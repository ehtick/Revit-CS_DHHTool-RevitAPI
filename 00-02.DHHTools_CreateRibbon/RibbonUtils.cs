...
namespace DHHTools
{
    ...
    {
        private DhhConstraint _dlqConstraint;
        private string _imageFolder;
        private string _dllFolder;

        public RibbonUtils(ControlledApplication a)
        {
            _dlqConstraint = new DhhConstraint(a);
            _imageFolder = _dlqConstraint.ImageFolder;
            _dllFolder = _dlqConstraint.DllFolder;
        }
        ...
        /// <summary>
        /// Tạo một PushButtonData Loại 2.
        /// </summary>
        /// <param name="name">Unique Name</param>
        /// <param name="displayName">Name will be display on Ribbon</param>
        /// <param name="pathFolderdll">name of path file .dll</param>
        /// <param name="fullClassName">include Namespace and name of class inherited from IExternalCommand,
        /// eg. QApps.FormworkAreaCmd</param>
        /// <param name="image">eg. Icon32x32.png</param>
        /// <param name="tooltip"></param>
        /// <param name="helperPath">đường dẫn tới file help: pdf hoặc link youtube</param>
        ...
        /// <param name="linkYoutube"></param>
        /// <returns></returns>
        public PushButtonData CreatePushButtonData_Type2(
            string name, string displayName,
            string pathFolderdll, string fullClassName,
            string image, string tooltip,
            string helperPath = null,
            string longDescription = null,
            string tooltipImage = null,
            string linkYoutube = null)
        {
            ...
            //string path = @"C:\ProgramData\Autodesk\ApplicationPlugins\Q'AppsTraining.bundle\Contents\2017\dll\Lesson 01_Hello REVIT API.dll";
            //string path2 = Path.Combine(dllFolder, dllName);
            string imageFolderV2 = @"D:\WORKING\STUDY\Programming\C-Sharp\C-Sharp_DHHTools-DinhHoangHoa\00.DHHTools_TestCmd\Image";

            PushButtonData pushButtonData = new PushButtonData(name, displayName,
                pathFolderdll, fullClassName);

            // image hiển thị khi tạo PushButton riêng lẻ
            pushButtonData.LargeImage = CreateBitmapImage(imageFolderV2, image);

            // image nhỏ hơn, hiển thị khi tạo PushButton cho ItemsStacked
            pushButtonData.Image = CreateBitmapImage(imageFolderV2, image);
            ...
            string toolTipImage = null)
        {
            ...
            PulldownButtonData pulldownButtonData = new PulldownButtonData(name, displayName);
