...
namespace DHHTools
{
    public static class ParameterUtils
    {
        ...
        public static Definition GetOrCreateSharedParamsDefinition(DefinitionGroup defGroup,
        ...
        public static void CreateInstanceBindingParameter(Document doc, List<Category> categories,
            Definition paramDef,
        ...
        public static void CreateTypeBindingParameter(Document doc, List<Category> categories,
            Definition paramDef,
            BuiltInParameterGroup displayGroup)
        {
            // Create the category set for binding and add the category
