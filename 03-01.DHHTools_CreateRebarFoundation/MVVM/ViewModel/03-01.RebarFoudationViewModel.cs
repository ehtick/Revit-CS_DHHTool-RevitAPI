...
{
    public class RebarFoundationViewModel : ViewModelBase
    {
        ...
        public RebarColumnViewModel(ExternalCommandData commandData)
        {
            ...
            RebarColumnWindow rebarColumnWindow = new RebarColumnWindow(this);
