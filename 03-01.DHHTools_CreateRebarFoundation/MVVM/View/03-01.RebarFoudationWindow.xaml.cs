...
namespace DHHTools
{
    public partial class RebarFounationWindow : Window
    {
        // ReSharper disable once FieldCanBeMadeReadOnly.Local
        // ReSharper disable once InconsistentNaming
        // ReSharper disable once FieldCanBeMadeReadOnly.Local
        //private DhhConstraint _dhhConstraint = new DhhConstraint();
        public RebarFounationViewModel _viewModel;
        public UIDocument UiDoc;
        public Document Doc;
        public Element ColumnElement;
        public ExternalEvent MyExternalEvent;

        public RebarFounationWindow(RebarFounationViewModel viewModel)
        {
            InitializeComponent();
