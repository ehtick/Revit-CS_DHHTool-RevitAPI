...
namespace DHHTools
{
    public partial class PrintMultiFileWindow : Window
    {
        // ReSharper disable once FieldCanBeMadeReadOnly.Local
        // ReSharper disable once InconsistentNaming
        // ReSharper disable once FieldCanBeMadeReadOnly.Local
        //private DhhConstraint _dhhConstraint = new DhhConstraint();
        public PrintMultiFileViewModel _viewModel;
        ...
        public PrintMultiFileWindow(PrintMultiFileViewModel viewModel)
        {
            InitializeComponent();
